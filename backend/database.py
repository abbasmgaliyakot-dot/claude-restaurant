...
MONGO_URL = os.getenv("MONGO_URL", "mongodb+srv://abbasmgaliyakot_db_user:vxjDMx1uUHYJz21b@cluster0.dx3cboz.mongodb.net/ClaudeResta?retryWrites=true&w=majority&tls=true")
DB_NAME = os.getenv("DB_NAME", "ClaudeResta")
